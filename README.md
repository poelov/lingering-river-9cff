...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lingering-river-9cff)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-river-9cff
```

A live public deployment of this template is available at [https://lingering-river-9cff.templates.workers.dev](https://lingering-river-9cff.templates.workers.dev)
